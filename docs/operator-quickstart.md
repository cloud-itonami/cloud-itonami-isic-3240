# Operator Quickstart — Manufacture of games and toys

Shortest path from clone to a verified local dry-run for **ISIC 3240** (`cloud-itonami-isic-3240`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3240.git
cd cloud-itonami-isic-3240
```
...
- Blueprint governor key: `toys-games-plant-operations-governor`
- Likely source path: `toysmfg.governor.cljc`
