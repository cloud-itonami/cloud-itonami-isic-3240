# Business Model: Manufacture of games and toys
...
## Classification
- Repository: `cloud-itonami-isic-3240` ([github.com/cloud-itonami/cloud-itonami-isic-3240](https://github.com/cloud-itonami/cloud-itonami-isic-3240))
- ISIC Rev.5: `3240` — Manufacture of games and toys
- Domain: `:games-and-toys/manufacturing`
- Social impact: :worker-safety :materials-safety :consumer-protection :child-safety
- Actor: `:toys-games-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :games-and-toys/manufacturing — who wants
...
One managed tenant (:games-and-toys/manufacturing):
...
- Do not bypass the `:toys-games-plant-operations-governor` for production decisions.
