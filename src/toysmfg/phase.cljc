(ns toysmfg.phase
  "Phase 0->3 staged rollout for the games-and-toys plant-operations
  coordination actor.
  ...
  is always a human plant supervisor's call. `toysmfg.governor`'s
...
(defn verdict->disposition
  "Map a Toys & Games Plant Operations Governor verdict to a base
